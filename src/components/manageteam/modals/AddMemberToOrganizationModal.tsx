...
import { memberType, memberRoles } from "./OrganizationRoles";
...
const AddMemberToOrganizationModal: React.FC<addMemberProps> = ({
  setCurrentModal,
  handleCloseModal,
  refetch,
}) => {
  ...
  const [selectedUser, setSelectedUser] = useState("Account User");
  ...
  const { addMember, members } = useOrganizationMembers();
            ...
            >
              <div className="flex flex-col items-center justify-center w-full max-h-[30.52vw]">
                <div className="flex flex-col justify-center items-start w-full">
                  <div
                    className="flex items-center justify-center w-[5.21vw] h-[5.21vw] rounded-full bg-cover bg-center relative cursor-pointer group"
                    style={{
                  ...
                  >
                    {selectedImage && (
                      <button
                        ...
                        className="hidden w-[5.21vw] h-[5.21vw] group-hover:flex items-center justify-center text-[#2424  d1b2] hover:border-[#b4b4c8] hover:bg-[#f4f4fa00] p-2 rounded-full cursor-pointer border-[#E0E0E9] border hover:text-[#282833] absolute inset-0"
                      >
                  ...
                  <div className="flex items-center justify-start w-full mt-[1.04vw] space-x-[0.58vw] space-x-[0.32vw]">
                    <a
                      ...
                      className="p-[0.52vw_1.04vw] font-normal text-[0.83vw] leading-[1vw] w-[4.79vw] h-[2.08vw] mx-[0.25vw] bg-[#ffffff] border-[0.05vw] border-solid border-[#e0e0e9] rounded-[0.78vw] flex-none grow-0 outline-none capitalize cursor-pointer hover:bg-[#f4f4fa] hover:border-[#b8b8cd] hover:text-very-dark-grayish-blue"
                    >
                  ...
                  <div className="flex flex-col items-start justify-center mt-[1.04vw] w-full">
                    ...
                    <div className="flex flex-col items-start justify-center mt-[1.04vw] space-y-[0.73vw] w-full relative">
                      ...
                      {selectedRoleDropdown && (
                        <ul
                          ref={dropdownRef}
                          className="absolute bottom-3/4 left-0 w-full flex flex-col items-center p-[0.52vw] gap-[0.52vw] max-h-[12.590vw] max-h-[10vw] bg-[#ffffff] rounded-[0.78vw] font-normal text-[0.94vw] leading-[120%] flex-none grow-0 order-1 z-[1] overflow-y-auto scrollbar-gutter-stable"
                          style={selectStyle}
                        >
              ...
              <div className="w-full mt-[2.08vw] space-x-[1.04vw] flex items-center justify-center">
                ...
                >
                  {/* {loading ? <ClipLoader size={18} color="#ffffff" /> : "Add"} */}
                  Add
                </button>
              </div>
            </form>
