...
const CompanySearch:React.FC<securityProps> = ({searchQuery, setIsFocus, setSearchQuery, setEmpty}) => {
const [searchable, setSearchable] = useState([
    {
        title: "Company Profile",
        locate: "Company Profile",
        href: "/companyprofile"
    },
    {
...
const searchItems = searchable?.filter((item: any) =>
  ...
  return (
    <div className='pt-[0.83vw] border-t '>
        <p className=' font-[600] text-[0.93vw] sticky top-0'>Company Profile</p>
      {searchItems?.map((item: any, index: number) => (
        ...
        onClick={() => handleNavigate(item.href)}
            ...
            <Image src={companyImage} alt="email" />
              <div>
